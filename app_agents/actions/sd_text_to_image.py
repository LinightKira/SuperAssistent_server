...
default_negative_prompt = ('EasyNegative,(NSFW),lowers, bad anatomy, bad hands, text, error, missing fingers, '
...
class SD_t2i(Action):
    ...
    def __init__(self, name: str = "", sd_model: str = "GhostMix-V2.0-fp16-BakedVAE", prompts: str = "", save_path: str = "",
                 *args,
                 **kwargs):
